...
public class UserController {
	...
	//의존성 주입(DI) : 스프링으로 부터 UserDAO객체를 주입 받음.
	@Autowired
//	private UserMapper mapper; // 이전에는 UserDAO dao = new UserDAO()
	private UserService service;

	// Message Converter API : jackson
	// ==> JSON 형식의 데이터를 자바객체로 또는
	...
	//					java 객체 --> JSON형식으로 변환해서 클라이언트 전송
